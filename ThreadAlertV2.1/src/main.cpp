...
const int numSalle = 103;
const char* batiment = "E";
const int etage = 1;
const int capaMax = 13;

const int idEsp = 1;
const char* versionEsp = "ESP32 S2 Saola Wrover";
...
void setup() {
  ...
  cB->connexionMQTT(mqttServer, mqttPort, mqttUser, mqttPassword, idEsp, versionEsp, numSalle, batiment, etage, capaMax);
